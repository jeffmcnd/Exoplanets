...
interface PlanetsApi {
    ...
    fun get(
            ...
            @Query("select") select: String = "pl_name,pl_hostname,pl_letter,pl_discmethod,pl_pnum,pl_orbper,pl_bmassj,pl_radj,pl_dens,st_dist,st_teff,st_mass,st_rad,pl_disc",
